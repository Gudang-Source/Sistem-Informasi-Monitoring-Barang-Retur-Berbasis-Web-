...
else 
{
	...
	$queryProduct = "SELECT A.productID, A.productCode, A.productName, B.stock FROM barang A LEFT JOIN as_stock_products B ON A.productID=B.productID WHERE A.productCode LIKE '%$q%' OR A.productName LIKE '%$q%' AND B.factoryID = '$factoryID'";
