...
if ($_SESSION['staffID'] == '' && $_SESSION['email'] == '')
{
	...
	try
	{
	    $html2xls = new HTML2XLS('L', array('240', '130'),'fr', false, 'ISO-8859-15',array(2, 2, 2, 2)); //setting ukuran kertas dan margin pada dokumen anda
		// $html2xls->setModeDebug();
		$html2xls->setDefaultFont('Arial');
		$html2xls->writeHTML($content, isset($_GET['vuehtml']));
		$html2xls->Output($filename);
	}
    catch(HTML2XLS_exception $e) { echo $e; }	
}
?>