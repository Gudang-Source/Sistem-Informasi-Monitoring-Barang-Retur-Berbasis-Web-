		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 290mm;'>
						<tr>
							...
							<th style='width: 25mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NO FAKTUR</th>
							<th style='width: 23mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NO PO</th>
							<th style='width: 27mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>TANGGAL</th>
							<th style='width: 10mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NO</th>
							<th style='width: 31mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NAMA BARANG</th>
							<th style='width: 23mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>HARGA</th>
							<th style='width: 18mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>QTY</th>
						...
						while ($dtBbm = mysqli_fetch_array($sqlBbm))
						{
							...
							$queryDetail = "SELECT * FROM detail_fakturbeli WHERE bbmFaktur = '$dtBbm[bbmFaktur]' AND nofaktur = '$dtBbm[nofaktur]'";
							$sqlDetail = mysqli_query($connect, $queryDetail);
							
							$content .= "
									<tr valign='top'>
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt;'>$i</td>
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt;'>$dtBbm[nofaktur]</td>
							...
							while ($dtDetail = mysqli_fetch_array($sqlDetail))
							{
								...
								$content .= "
									<tr valign='top'>
										...
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt; text-align:center; '>$subtotal<br></td>
									</tr>
								";
								$k++;
							}
							...
							$content .= "<tr valign='top'>
											...
											<td style='padding: 2px 0px 2px 0px; font-size: 9pt; text-align: right;'>$grandtotal<br><br><br></td>
										</tr>";	
							$i++;
						}
			$content .= 
