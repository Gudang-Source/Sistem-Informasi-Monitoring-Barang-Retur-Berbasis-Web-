									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											<!--		<td>{$dataRetur[dataRetur].staffName}</td> -->
													<td>
														<a title="Detail" href="retur_suppliers.php?module=returbuy&act=detailretur&returID={$dataRetur[dataRetur].returID}&returNo={$dataRetur[dataRetur].returNo}&nofaktur={$dataRetur[dataRetur].nofaktur}&page={$page}"><img src="img/icons/view.png" width="18"></a>
														<a title="Delete" href="retur_suppliers.php?module=returbuy&act=delete&returID={$dataRetur[dataRetur].returID}&returNo={$dataRetur[dataRetur].returNo}&nofaktur={$dataRetur[dataRetur].nofaktur}" onclick="return confirm('Anda Yakin ingin membatalkan retur {$dataRetur[dataRetur].returNo}? penghapusan ini akan membatalkan seluruh retur barang dan lainnya terkait retur ini.');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
