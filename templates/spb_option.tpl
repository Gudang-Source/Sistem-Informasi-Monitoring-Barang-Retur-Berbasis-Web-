											...
											{section name=dataDetilTransfer loop=$dataDetilTransfer}
												<tr>
													...
													<td>
														...
														<a title="Delete" href="transfers.php?module=transfer&act=deletedetail&detailID={$dataDetilTransfer[dataDetilTransfer].detailID}" onclick="return confirm('Anda Yakin ingin menghapus item barang {$dataDetilTransfer[dataDetilTransfer].productName}?');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
